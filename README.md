...
```bash
git clone https://github.com/shahriarkabir280/Brainwave.git
cd Brainwave
```
...
## <a name="more"> 🚀 More </a>
**This project is done by following a tutorial and resources of JavaScript Mastery:**
-[Tutorial](https://youtu.be/B91wc5dCEBA?si=oGTKSOv8Kb0pvCb_)
#
